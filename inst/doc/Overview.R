...
## ----extraction-2, warning = FALSE, fig.width = 3, fig.height = 3--------
qplot(
      fitted(res),
      globulus$phe_X) +
  geom_abline(int = 0,
...
## ----prediction-fit, echo = FALSE, warning=FALSE---------------------------------------------------------------------------
