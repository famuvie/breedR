...
```{r hierarchical-exercise, purl=FALSE, message=FALSE}
...
```{r factorial-exercise, purl=FALSE, message=FALSE}
...
```{r interaction-exercise, purl=FALSE}
summary(res)
summary(res.h)
```
...
```{r factorial-summary, purl=FALSE}
summary(res.f)
```

```{r AIC-factorial, message=FALSE, purl=FALSE}
...
- The heritability is computed automatically as $h^2 = \frac{\sigma_a^2}{\sigma_a^2 + \sigma^2}$
...
```{r spatial-exercise-1, purl = FALSE, message=FALSE}
...
```{r spatial-exercise-1-results, purl = FALSE, echo = FALSE}
summary(res.spl)
summary(res.spl99)
```
...
```{r spatial-exercise-3, purl = FALSE, message=FALSE}
...
```{r prediction-exercise-2, purl = FALSE, message = FALSE, echo = 1:4, results = 'asis'}
