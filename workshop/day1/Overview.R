...
## ----hierarchical-exercise, purl=TRUE, message=FALSE, eval = FALSE-------
## res.h <- remlf90(fixed = phe_X ~ 1,
##                  random = ~ factor(mum) + gg,
##                  data = globulus)
## 

## ----factorial-exercise, purl=TRUE, message=FALSE, eval = FALSE----------
...
## ----interaction-exercise, purl=TRUE, eval = FALSE-----------------------
## summary(res)
## summary(res.h)

## ----factorial-summary, purl=TRUE, eval = FALSE--------------------------
## summary(res.f)

## ----AIC-factorial, message=FALSE, purl=TRUE, eval = FALSE---------------
...
## ----spatial-exercise-1, purl = TRUE, message=FALSE, eval = FALSE--------
...
## ----spatial-exercise-2, purl = TRUE, eval = FALSE-----------------------
## qplot(rho_r, rho_c,
##       fill = loglik,
##       geom = 'tile',
##       data = res.ar1$rho)

## ----spatial-exercise-3, purl = TRUE, message=FALSE, eval = FALSE--------
...
## ----prediction-exercise-1, purl = TRUE, results = 'asis', echo = -4-----
