...
# pedigree with repeated observations
# TODO
# - Use something random, but each obs. repeated three times
# - verify that build_pedigree() passes all checks from check_pedigree()
# - verify that remlf90() builds and recodes the pedigree
# - verify that get_pedigree() returns the recoded pedigree
